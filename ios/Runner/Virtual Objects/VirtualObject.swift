...
class VirtualObject: SCNReferenceNode {
    ...
    var modelName: String {
        return referenceURL.lastPathComponent.replacingOccurrences(of: ".glb", with: "")
    }
...
extension VirtualObject {
    ...
    static let availableObjects: [VirtualObject] = {
        ...
        return fileEnumerator.compactMap { element in
            ...
            let fileURL = getDocumentsDirectory().appendingPathComponent("f0307c2b-4804-4e9e-9440-1369a6b2f2c8_88036636.usdz")
            return VirtualObject(url: fileURL)
        }
    }()
